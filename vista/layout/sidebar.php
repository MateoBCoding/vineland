    ...
    <ul class="side-menu-list p-0">
        ...
        <li class="grey with-sub">
            ...
            <ul>
                ...
                <li>
                    <a href="../vista/Lista_entrevistados.php" class="">
            ...
            <li class="grey with-sub">
                ...
                <ul>
                    <?php if (isset($_SESSION['receptiva'])) { ?>
                        <li class="grey with-sub">
                            <span class="lbl">Comunicacion</span>
                            <ul>
                                <li>
                    ...
                    <?php if (isset($_SESSION['personal'])) { ?>
                        <li class="grey with-sub">
                            <span class="lbl">Habilidades Vida Diaria</span>
                            <ul>
                                <li>
                    ...
                    <?php if (isset($_SESSION['interpersonales'])) { ?>
                        <li class="grey with-sub">
                            <span class="lbl">Socializacion</span>
                            <ul>
                                <li>
                    ...
                    <?php if (isset($_SESSION['gruesa'])) { ?>
                        <li class="grey with-sub">
                            <span class="lbl">Habilidades Motoras</span>
                            <ul>
                                <li>
